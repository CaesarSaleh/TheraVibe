...
public class Program
{
    ...
    public static async Task<string> transcribe(String path){
        HttpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("597cb43f978b43c2ad5e42dc65f2e46c");
    ...
    static async Task<string> UploadFileAsync(string path){
    ...
    static async Task<string> GetTranscriptAsync(string audioUrl){
